...
export const demoComics: DemoComic[] = [
  {
    ...
    thumbnail: "/default-image/comic2.jpg?height=300&width=200&text=Dragon's+Legacy",
    category: "Fantasy",
    status: "ongoing",
    rating: 4.8,
    views: 125000,
        ...
        pages: [
          {
            ...
            episodeId: "ep-1-1",
            pageNumber: 1,
            imageUrl: "/default-image/comic2.jpg?height=800&width=600&text=Page+1",
          },
          {
            id: "page-1-1-2",
            episodeId: "ep-1-1",
            pageNumber: 2,
            imageUrl: "/default-image/comic2.jpg?height=800&width=600&text=Page+2",
          },
          {
            id: "page-1-1-3",
            episodeId: "ep-1-1",
            pageNumber: 3,
            imageUrl: "/default-image/comic2.jpg?height=800&width=600&text=Page+3",
          },
        ],
      },
    ],
  },
  {
    ...
    thumbnail: "/default-image/comic2.jpg?height=300&width=200&text=Neon+Dreams",
    category: "Sci-Fi",
    status: "ongoing",
    rating: 4.6,
    views: 98000,
  ...
  },
  {
    ...
    thumbnail: "/default-image/comic2.jpg?height=300&width=200&text=Hearts+Entwined",
    category: "Romance",
    status: "completed",
    rating: 4.9,
    views: 156000,
    ...
    episodes: [
      {
        ...
        pages: [
          ...
          },
          {
            ...
            episodeId: "ep-3-1",
            pageNumber: 4,
            imageUrl: "/default-image/comic2.jpg?height=800&width=600&text=Page+4",
          },
        ],
      },
    ],
  },
  {
    ...
    thumbnail: "/default-image/comic2.jpg?height=300&width=200&text=Shadow+Warrior",
    category: "Action",
    status: "ongoing",
    rating: 4.7,
    views: 203000,
  ...
  },
  {
    ...
    thumbnail: "/default-image/comic2.jpg?height=300&width=200&text=The+Missing+Heir",
    category: "Mystery",
    status: "ongoing",
    rating: 4.5,
    views: 87000,
  ...
  },
  {
    ...
    thumbnail: "/default-image/comic2.jpg?height=300&width=200&text=Midnight+Terrors",
    category: "Horror",
    status: "hiatus",
    rating: 4.3,
    views: 45000,
  ...
  },
  {
    ...
    thumbnail: "/default-image/comic2.jpg?height=300&width=200&text=Laugh+Out+Loud",
    category: "Comedy",
    status: "ongoing",
    rating: 4.4,
    views: 112000,
  ...
  },
  {
    ...
    thumbnail: "/default-image/comic2.jpg?height=300&width=200&text=Coffee+Shop+Chronicles",
