      ...
      >
        <Card className="shadow-xl border-0">
          <CardHeader className="text-center space-y-2">
            ...
            <CardDescription>Create your account to start your comic journey</CardDescription>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                ...
                disabled={
                  loading || !formData.agreeToTerms || !passwordsMatch || !passwordRequirements.every((req) => req.met)
                }
              >
                {loading ? (
                  <div className="flex items-center space-x-2">
